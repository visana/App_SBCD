...
$( document ).ajaxStop(function() {	"use strict";  $( "#loader" ).hide(); 	
	...
	$('#turismo').click(function(){
		if(!$(this).hasClass('active')){
			...
			$('#conheca_goias').parent().show();
			$('#o_que_fazer').parent().show();
		}else {
			$(this).removeClass('active');
			$('#conheca_goias').parent().hide();
			$('#o_que_fazer').parent().hide();
		}
	});
	$('#conheca_goias').click(function(){
		$('.conheca_goias').show();
		limpaCampo();
	});
	$('#o_que_fazer').click(function(){
		$('.o_que_fazer').show();
		limpaCampo();
	});
	$('#mapa').click(function(){
